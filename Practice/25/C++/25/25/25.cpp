...
void print_vector(vector_t vector, const char * start = "", const char * delim = " ", const char * end = "\n");
void print_matrix(matrix_t matrix, const char * start = "", const char * delim = " ", const char * end = "\n");
int main() {
	int n;
	std::cin >> n;
	matrix_t matrix;
