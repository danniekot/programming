...
template<class T>
void print_vector(vector_t<T> vector, const char * start = "", const char * delim = " ", const char * end = "\n");

template<class T>
void print_matrix(matrix_t<T> matrix, const char * start = "", const char * delim = " ", const char * end = "\n");
