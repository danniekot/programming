...
void Randomizer() {
	...
	while (1) {
		...
		if ((current_city[-1] == 'ъ' || current_city[-1] == 'ы' || current_city[-1] == 'ь') && current_city.length() > 2)
			letter_index = int(strchr(letters.c_str(), current_city[current_city.length() - 2]));
		else if ((current_city[-1] == 'ъ' || current_city[-1] == 'ы' || current_city[-1] == 'ь') && current_city.length() == 2)
			letter_index = int(strchr(letters.c_str(), current_city[current_city.length() - 2]));
		else if ((current_city[-1] != 'ъ' && current_city[-1] != 'ы' && current_city[-1] != 'ь') && current_city.length() > 2)
